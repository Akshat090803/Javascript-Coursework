...
//! Imp
// false || console.log('or') //will print
// true || console.log('or') //will not print
// true && console.log('and ') //will  print
// false && console.log('and ') //will not print
...
// let eligible =(age>=18) && hadDrivingLicense; //true
...
//!Associativity left to right means first 2 < 12 evalutes to 1 (true) than 1 < 5 to true (1)
// console.log(2 < 12 < 5); //true 1
// console.log(5 > 12 > 2); //false 0
...
var a=b=c=10;
// For a single assignment, it is left to right.
// - For chained assignments, it evaluates from right to left.
