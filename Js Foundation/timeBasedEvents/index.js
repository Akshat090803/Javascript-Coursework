...
// ! Then, set up an interval using setInterval() to call repeatedFunction every 1000 milliseconds.  Additionally,
// ! after 5 seconds have elapsed, use setTimeout() to clear the interval previously set up. 
...
// }
// repeatedFunction();
// // we call this bcoz we want our function to call 5 times in 5 sec else we not do this than our func will get call
// // only 4 times in 5 sec bcoz first time fucntion call after 1000 ms so in 5000ms it will call 4times 

// const TimeInterval=setInterval(()=>{repeatedFunction();},1000);
