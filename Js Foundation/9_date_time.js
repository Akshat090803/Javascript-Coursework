...
// const datestring ="2023-04-01T14:41:12.894Z";
...
// console.log(date1);
// const date2=new Date(2222,11);
// console.log(date2);
// in java script months start from 0 to 11
...
// const date3 = new Date("5 march, 2024"); // day month, Year
// console.log(date1);
// console.log(date2);
// console.log(date3);
...
//     //  this will give millisecs
//     const newMillisec=date.setDate(date.getDate()+extra);
// // this will return date from millisec
...
//     const diffDay=newdate.getDate()-1;

//     return diffDay;
// }
//  !way 2
const getDaysDifference=(date1,date2)=>{
    let millisecondInOneDay=24*60*60*1000;
    const diff=Math.abs(date1-date2); //this will give difference of millisiconds
    return Math.round(diff/millisecondInOneDay);
}


const date1 = new Date("2023-05-10");
const date2 = new Date("2024-04-08");
console.log(getDaysDifference(date1, date2)); // Output: 11 (difference in days)

// !!!!!!!!!! to get time in 12 hr format
// new Date().toLocaleTimeString('en-US',{hours12:true})
